                        ...
                        <div class="sidebar-widget categories">
                            <div class="widget-content">
                                ...
                                <ul class="services-categories">
                                    <li><a href="services-detail.php">All Services</a></li>
                                    <li class="active"><a href="service-detail.php">Install & Configure</a></li>
                                    <li><a href="services-detail.php">Repair & Service</a></li>
                                    <li><a href="services-detail.php">Maintenance</a></li>                                    
                                    <li><a href="services-detail.php">Video Verification</a></li>
                                    <li><a href="services-detail.php">Video Surveillence</a></li>
                                    <li><a href="services-detail.php">Interactive Security</a></li>
                                </ul>
                            </div>
                        </div>
